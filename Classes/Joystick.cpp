...
bool Joystick::init()
{
    ...
    Vec2 centerPos = Vec2(125,125);
    
    // Joystick - Back Sprite (Limit)
    joystick_limit = Sprite::create();
    joystick_limit->setSpriteFrame("Joystick0.png");
    joystick_limit->setPosition(centerPos);
    this->addChild(joystick_limit);
    
    
    // Joystick - Front Sprite (Controler)
    joystick_control = Sprite::create();
    joystick_control->setSpriteFrame("Joystick1.png");
